...
function capAndLow(str){
    var beginIndex =  findMiddleIndex(str);
    var firstHalf = returnFirstHalf(str);
    firstHalf = firstHalf.toUpperCase();
    var secondHalf = returnSecondHalf(str);
    secondHalf = secondHalf.toLowerCase(secondHalf);
...
function returnSecondHalf(str) {
    var pos = findMiddleIndex(str);
    var secondHalf = str.slice(pos);
    return secondHalf;
}
